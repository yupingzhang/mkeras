...
def setmodel(input_shape, mtx, mtx_1):
    print input_shape[0]
    mesh_in = Input((input_shape[0], 18), name='mesh_input')

    smoo_1 = Smooth(units=18, name='smoo_layer_1')(mesh_in)
    pool_1 = Densepool(mtx=mtx, mtx_1=mtx_1, name='pool_layer_1')(smoo_1)

    smoo_1 = Smooth(units=18, name='smoo_layer_2')(pool_1)
    pool_2 = Densepool(mtx=mtx, mtx_1=mtx_1, name='pool_layer_2')(smoo_1)

    smoo_1 = Smooth(units=18, name='smoo_layer_3')(pool_2)
...
def main():
    ...
    if args.train:    
        ...
        print ">>>>>>> loading data... target data: delta >>>>>>> "
